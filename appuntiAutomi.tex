...
\begin{document}
	...
	\section{Decidibilità e macchine di Turing}
		...
		\subsection{Macchine di Turing}
			...
			\subsubsection{Varianti}
				...
				\includepdf[pages={106}]{Dovier-Giacobazzi-dispense.pdf}
		...
		\subsection{Linguaggi decidibili}
			...
			\includepdf[pages={4,7,9,11,13,14,16,17}, scale=0.75]{14-decidibili.pdf}
			Vediamo ora i \textbf{problemi sui linguaggi Context-free}, mostrando direttamente gli esempi:
			\includepdf[pages={19,21,22,23,25}, scale=0.75]{14-decidibili.pdf}
			...
			\includepdf[pages={27,28,29}, scale=0.75]{14-decidibili.pdf}
		\subsection{Indecidibilità e riducibilità}
			...
			\subsubsection{Indecidibilità}
				...
				\includepdf[pages={5,8-10,12,15-17,19-22}, scale=0.75]{15-indecidibili.pdf}
			\subsubsection{Riducibilità}
				...
				\includepdf[pages={7,8,9,10,12,13,14,15,17,18,19,20}, scale=0.75]{16-riducibilita.pdf}
	\section{Teoria della complessità}
		...
		\subsection{Problemi NP completi}
			...
			\includepdf[pages={5-10,12-13,15,16,18-25,27,28,33,36-38,42,45,50-52,57-61,63,67-68,73,77,80-81,84-85,87,94,101-102}, scale=0.75]{20-npcompletezza.pdf}
			\includepdf[pages={7-34}]{12-nphard.pdf}
	\section{Esercizi svolti}
		...
		\includepdf[pages=-]{Tutorato/06SolTutorato.pdf}
		\includepdf[pages=-]{Esempi di esame - Testi e soluzioni (1)/210901_esame_alf_soluzioni.pdf}
		\includepdf[pages=-]{Tutorato/08SolTutorato.pdf}
\end{document}
